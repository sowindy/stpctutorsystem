...
define('UC_DBPW', 'cutegirl21');					// UCenter 数据库密码
define('UC_DBNAME', 'ucenter');				// UCenter 数据库名称
define('UC_DBCHARSET', 'utf-8');				// UCenter 数据库字符集
define('UC_DBTABLEPRE', 'ucenter.uc_');			// UCenter 数据库表前缀

//通信相关
define('UC_KEY', 'cutegirl21');				// 与 UCenter 的通信密钥, 要与 UCenter 保持一致
...
$dbuser = 'root';			// 数据库用户名
$dbpw = 'cutegirl21';				// 数据库密码
$dbname = 'quoracms';			// 数据库名
$pconnect = 0;				// 数据库持久连接 0=关闭, 1=打开
$tablepre = 'qcs_';   		// 表名前缀, 同一数据库安装多个论坛请修改此处
