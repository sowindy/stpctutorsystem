...
<script type="text/javascript" src="__PUBLIC__/index.js"></script>
	<div id="main">
    	<div id="index_left">
            ...
            <div class="clear"></div>
            <a id="enter_all" href="<?php echo U('Index/all'); ?>" onclick="this.style.background='#eee';this.innerHTML='跳转中...'">进入<?php echo ($sign); ?>中心</a>
        </div>
        <div id="index_right">
                ...
                <div class="side_wrapper">
                    <div class="side_title">热门用户<a href="<?php echo U('User/ranklist'); ?>" target="_blank" class="user_more">更多>></a></div>
                    <?php if(S('side_hot_user')==0)
                        {
