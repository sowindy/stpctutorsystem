                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td style="width: 25%">
                                                    ...
                                                    <a href="#yes<?php echo ($one["id"]); ?>" class="btn btn-small btn-danger" data-toggle="modal">已毕业</a>
                                                    <div id="yes<?php echo ($one["id"]); ?>" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                                        <div class="modal-header">
                                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                                            <h3 id="myModalLabel">此学生确定毕业么了吗？</h3>
                                                        </div>
                                                        <div class="modal-footer">
                                                            <form action="<?php echo U('Tutor/graduate');?>" method="post">
