			...
			<div class="main-content">
				...
				<div class="page-content">
                                    <table class="table table-bordered table-hover table-striped">
                                        ...
                                        <tbody>
                                            <?php $i = 1;foreach($all_publish_tutor as $one): ?>
                                            <tr>
                                                <td><?php echo ($i); ?></td>
                                                ...
                                                <td>
                                                    ...
                                                    <?php if($one['operate']): ?>
                                                    <a href="#choose<?php echo ($one["id"]); ?>" class="btn btn-info btn-small" data-toggle="modal">选择导师</a>
                                                    <div id="choose<?php echo ($one["id"]); ?>" class="modal hide fade span8" style="left: 20%" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                                        <div class="modal-header">
                                                                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                                                <h3 id="myModalLabel">您确定选择此导师吗？</h3>
                                                        </div>
                                                        <form method="post" action="<?php echo U('Stu/tutorhandler');?>">
                                                        <div class="modal-body">
                                                            <input type="hidden" name="ha" value="<?php echo ($ha); ?>" />
                                                            <input type="hidden" name="tutor_id" value="<?php echo ($one["id"]); ?>" />
                                                        </div>
                                                        <div class="modal-footer">
                                                    ...
                                                    <?php else: ?>
                                                    <a href="#" class="btn btn-info btn-small disabled">选择导师</a>
                                                    <?php endif; ?>
                                                </td>
                                            </tr>
                                            <?php $i++;endforeach; ?>
