				...
				<div class="breadcrumbs" id="breadcrumbs">
					<div style="float: right;">
                    	...
                    	<div id="detail_import_teacher" class="modal hide fade span8" style="left: 20%" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                       	...
                       	<a href="#detail_import_stu" class="btn btn-success btn-small" data-toggle="modal">导入老师</a>
                    	<div id="detail_import_stu" class="modal hide fade span8" style="left: 20%" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                    		<form action="<?php echo U('import_stu');?>" method="post" enctype="multipart/form-data">
                        	<div class="modal-header">
                                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                <h3 id="myModalLabel">请上传要导入的学生文件</h3>
                            </div>
                            <div class="modal-body">
                            	<h4 class="text-warning">请注意excel文本格式的正确性，否则会出现意想不到的错误！</h4>
                            	<input type="file" name="teacher" class="ace-file-input input" />
