			...
			<div class="main-content">
				...
				<div class="page-content">					
                                    <div class="span8 offset1">
                                        <form class="form-horizontal" id="form" method="post" action="<?php echo U('Stu/infohandler');?>" />
                                            <input type="hidden" name="ha" value="<?php echo ($ha); ?>" />
                                            <div class="control-group">
                                                    <label class="control-label" for="form-field-1">学号：</label>

                                                    <div class="controls">
                                                        <div class="span6">
                                                            <input type="text" name="stu_number" class="span6" id="form-field-1" placeholder="如“PB14025911”" value="<?php echo ($stuinfo["stu_number"]); ?>" />
                                                    </div>
                                            </div>
                                                    <br><br>
                                            <div class="control-group">
                                                    ...
                                                    <div class="controls">
                                                        <div class="span6">
                                                            <input type="text" name="stu_name" class="span6" id="form-field-1"  placeholder="如“张三”" value="<?php echo ($stuinfo["stu_name"]); ?>" />
                                                        </div>
                                                    </div>
                                            </div>
                                            <div class="control-group">
                                                    ...
                                                    <div class="controls">
                                                        <div class="span6">
                                                            <input name="stu_sex" type="radio" checked value="1" />
                                                            <span class="lbl span1">男</span>
                                                            <input name="stu_sex" type="radio" value="0" />
                                            ...
                                            <div class="control-group">
                                                    ...
                                                    <div class="controls">
                                                        <div class="span6">
                                                            <input type="text" name="stu_phone" class="span6" id="form-field-1" placeholder="如“13721093421”" value="<?php echo ($stuinfo["stu_phone"]); ?>" />
                                                        </div>
                                                    </div>
                                            </div>
                                            <div class="control-group">
                                                    ...
                                                    <div class="controls">
                                                        <div class="span6">
                                                            <input type="text" name="stu_email" id="form-field-1" class="span6" placeholder="如“youname@ustc.edu.cn”" value="<?php echo ($stuinfo["stu_email"]); ?>" />
                                                        </div>
                                                    </div>
                                            </div>
                                            <div class="control-group">
                                                    <label class="control-label" for="form-field-2">QQ：</label>

                                                    <div class="controls">
                                                        <div class="span6">
                                                            <input type="text" name="stu_QQ" id="form-field-1" class="span6" placeholder="如“844209911”" value="<?php echo ($stuinfo["stu_QQ"]); ?>" />
                                                        </div>
                                                    </div>
                                                    
                                            </div>
                                            <div class="control-group">
                                                    <label class="control-label" for="form-field-2">工作单位：</label>

                                                    <div class="controls">
                                                        <div class="span6">
                                                            <input type="text" name="stu_workplace" id="form-field-1" class="span6" placeholder="如为应届生请填写“中国科大”" value="<?php echo ($stuinfo["stu_workplace"]); ?>" />
                                                        </div>
                                                    </div>
                                            </div>
                                            <div class="control-group">
                                                    <label class="control-label" for="form-field-2">学习经历：</label>

                                                    <div class="controls">
                                                            <input type="hidden" id="studyexperience" name="stu_studyexperience" value="" />
                                                            <div class="span6">
                                                                    <div class="widget-box">
                                                                            ...
                                                                            <div class="widget-body">
                                                                                    <div class="widget-main no-padding">
                                                                                            <div class="wysiwyg-editor editor_form" id="stu_studyexperience"></div>
                                                                                    </div>
                                                                            </div>
                                                                    </div>
                                                            </div>
                                            ...
                                            <div class="control-group">
                                                    <label class="control-label" for="form-field-2">工作经历：</label>

                                                    <div class="controls">
                                                            <input type="hidden" id="workexperience" name="stu_workexperience" value="" />
                                                            <div class="span6">
                                                                    <div class="widget-box">
                                                                            <div class="widget-header widget-header-small  header-color-green">
                                                                                    <div class="widget-toolbar">
                                                                            ...
                                                                            <div class="widget-body">
                                                                                    <div class="widget-main no-padding">
                                                                                            <div class="wysiwyg-editor editor_form" id="stu_workexperience"></div>
                                                                                    </div>
                                                                            </div>
                                                                    </div>
                                                            </div>
                                            ...
                                            <div class="control-group">
                                                    <label class="control-label" for="form-field-2">论文、项目与获奖：</label>

                                                    <div class="controls">
                                                            <input type="hidden" id="honor" name="stu_honor" value="" />
                                                            <div class="span6">
                                                                    <div class="widget-box">
                                                                            <div class="widget-header widget-header-small  header-color-green">
                                                                                    <div class="widget-toolbar">
                                                                            ...
                                                                            <div class="widget-body">
                                                                                    <div class="widget-main no-padding">
                                                                                            <div class="wysiwyg-editor editor_form" id="stu_honor"></div>
                                                                                    </div>
                                                                            </div>
                                                                    </div>
                                                            </div>
                                            ...
                                            <div class="control-group">
                                                    <label class="control-label" for="form-field-2">自我评价：</label>

                                                    <div class="controls">
                                                            <input type="hidden" id="selfvalue" name="stu_selfvalue" value="" />
                                                            <div class="span6">
                                                                    <div class="widget-box">
                                                                            <div class="widget-header widget-header-small  header-color-green">
                                                                                    <div class="widget-toolbar">
                                                                            ...
                                                                            <div class="widget-body">
                                                                                    <div class="widget-main no-padding">
                                                                                            <div class="wysiwyg-editor editor_form" id="stu_selfvalue"></div>
                                                                                    </div>
                                                                            </div>
                                                                    </div>
                                                            </div>
...
<![endif]-->
		...
		<script type="text/javascript">
			...
			$(function(){
                    ...
                    $(function(){
                            $("input[name='stu_sex'][value='<?php echo ($stuinfo["stu_sex"]); ?>']").attr("checked", true);
                            $('#stu_studyexperience').append("<?php echo htmlspecialchars_decode($stuinfo['stu_studyexperience']); ?>");
                            $('#stu_workexperience').append("<?php echo htmlspecialchars_decode($stuinfo['stu_workexperience']); ?>");
                            $('#stu_honor').append("<?php echo htmlspecialchars_decode($stuinfo['stu_honor']); ?>");
                            $('#stu_selfvalue').append("<?php echo htmlspecialchars_decode($stuinfo['stu_selfvalue']); ?>");
                    });
                    $('#form').submit(
                        function(){
                            $('#studyexperience').val($('#stu_studyexperience').html());
                            $('#workexperience').val($('#stu_workexperience').html());
                            $('#honor').val($('#stu_honor').html());
                            $('#selfvalue').val($('#stu_selfvalue').html());
                        }
                    );
		</script>
	</body>
