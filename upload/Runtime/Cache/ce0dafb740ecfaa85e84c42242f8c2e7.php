                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <lable class="badge badge-important">教授</lable>
                                                    <?php elseif($one['position'] == 2): ?>
                                                    <lable class="badge badge-success">副教授</lable>
                                                    <?php elseif($one['position'] == 3): ?>
                                                    <lable class="badge badge-info">讲师</lable>
                                                    <?php endif; ?>
                                                </td>
                                                <td>
                                                    <?php if($one['status'] == 1): ?>
                                                    <label class="badge badge-info">已发布</label>
                                                    <?php elseif($one['status'] == 0): ?>
                                                    <label class="badge badge-important">未发布</label>
                                                    <?php endif; ?>
                                                </td>
                                                <td>
                                                    <label class="badge badge-important"><?php echo ($one["stunumber"]); ?></label>
                                                </td>
                                                <td>
                                                    <a href="#" class="btn btn-info btn-mini">查看详细</a>
                                                    <a href="<?php echo U('edittutor',array('id'=>$one['id']));?>" class="btn btn-success btn-mini">编辑信息</a>
                                                </td>
                                            </tr>
                                            <?php endforeach; ?>
                                        </tbody>
