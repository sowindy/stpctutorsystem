                                    ...
                                    <table class="table table-bordered table-condensed table-striped datatable">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo ($one["stu_phone"]); ?></td>
                                                <td><?php echo ($one["stu_email"]); ?></td>
                                                <td><?php echo ($one["stu_QQ"]); ?></td>
                                                <td>
                                                    <?php if($one['tutor'] == -1): ?>
                                                    <span class="badge badge-important">申请未分配</span>
                                                    <?php elseif($one['tutor'] == 0): ?>
                                                    <span class="badge badge-info">未申请导师</span>
                                                    <?php else: ?>
                                                    <span class="badge badge-success"><?php echo ($one["tutor"]["name"]); ?></span>
                                                    <?php endif; ?>
                                                </td>
                                                <td>
                                                    <?php if($one['practice'] == -1): ?>
                                                    <span class="badge badge-important">申请未分配</span>
                                                    <?php elseif($one['tutor'] == 0): ?>
                                                    <span class="badge badge-info">未申请实习</span>
                                                    <?php else: ?>
                                                    <span class="badge badge-success"><?php echo ($one["practice"]["corporate"]); ?></span>
                                                    <?php endif; ?>
                                                </td>
                                                <td>
                                                    <a href="#" class="btn btn-info btn-mini">查看详细</a>
                                                    <a href="<?php echo U('editstu',array('id'=>$one['id']));?>" class="btn btn-success btn-mini">编辑信息</a>
                                                </td>
                                            </tr>
                                            <?php endforeach; ?>
                                        </tbody>
