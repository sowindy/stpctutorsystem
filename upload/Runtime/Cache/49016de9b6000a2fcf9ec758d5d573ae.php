                                    ...
                                    <table class="table table-bordered table-hover table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td><?php echo ($i); ?></td>
                                                <td>
                                                    <a href="#detail<?php echo ($one["id"]); ?>" class="" data-toggle="modal"><?php echo ($one["stu_number"]); ?></a>
                                                ...
                                                <?php if($one['status'] == 0): ?>
                                                <td class="label-info">
                                                    <label class="text-center" style="color: #ffffff">待审核</label>
                                                </td>
                                                <?php elseif($one['status'] == 1): ?>
                                                <td class="label-success">
                                                    <label class="text-center" style="color: #ffffff">已通过</label>
                                                </td>
                                                <?php elseif($one['status'] == 2): ?>
                                                <td class="label-important">
                                                    <label class="text-center" style="color: #ffffff">已拒绝</label>
                                                </td>
                                                <?php elseif($one['status'] == 3): ?>
                                                <td class="label-info">
                                                    <label class="text-center" style="color: #ffffff">未审核</label>
                                                </td>
                                                <?php endif; ?>
                                            </tr>
                                            <?php $i++;endforeach; ?>
