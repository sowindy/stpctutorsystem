                                            ...
                                            <tr>
                                                ...
                                                <td style="width: 25%">
                                                    ...
                                                    <div id="yes<?php echo ($one["id"]); ?>" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                                        <div class="modal-header">
                                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                                            <h3 id="myModalLabel">您确定选择<?php echo ($one["stu_name"]); ?>吗？</h3>
                                                        </div>
                                                        <div class="modal-footer">
                                                            <form action="<?php echo U('Practice/yes');?>" method="post">
                                                                <input type="hidden" name="ha" value="<?php echo ($ha); ?>" />
                                                                <input type="hidden" name="stu_id" value="<?php echo ($one["id"]); ?>" />
                                                                <input type="hidden" name="practice_id" value="<?php echo ($one["practice_id"]); ?>" />
                                                    ...
                                                    <div id="no<?php echo ($one["id"]); ?>" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                                        <div class="modal-header">
                                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                                            <h3 id="myModalLabel">您确定拒绝<?php echo ($one["stu_name"]); ?>吗？</h3>
                                                        </div>
                                                        <form action="<?php echo U('Practice/no');?>" method="post">
                                                        <div class="modal-body">
