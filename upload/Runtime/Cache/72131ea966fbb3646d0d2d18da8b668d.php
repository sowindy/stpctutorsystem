			...
			<div class="main-content">
				...
				<div class="page-content">
                                    <table class="table table-bordered table-hover table-striped">
                                        ...
                                        <tbody>
                                            <?php $i = 1;foreach($tutor_to_choose as $one): ?>
                                            <tr>
                                                <td><?php echo ($i); ?></td>
                                                <td>
                                                    <a href="#detail<?php echo ($one["id"]); ?>" class="" data-toggle="modal"><?php echo ($one["name"]); ?></a>
                                                            ...
                                                            <div class="span7 infobox-container">
                                                                <div class="infobox infobox-green infobox-small infobox-dark" style="width: 200px">
                                                                        <div class="infobox-data">
                                                                                ...
                                                                                <div class="infobox-content"><?php echo ($one["name"]); ?></div>
                                                                        </div>
                                                                </div>
                                                                ...
                                                                <div class="infobox infobox-brown infobox-small infobox-dark" style="width: 200px">
                                                                        <div class="infobox-data">
                                                                                ...
                                                                                <div class="infobox-content">
                                                                                    <?php if($one['position'] == 1): ?>
                                                                                    教授
                                                                                    <?php elseif($one['position'] == 2): ?>
                                                                                    副教授
                                                                                    <?php elseif($one['position'] == 3): ?>
                                                                                    讲师
                                                                                    <?php endif; ?>
                                                                                </div>
                                                                        </div>
                                                                ...
                                                                <div class="infobox infobox-blue"  style="width: 600px">
                                                                        <div class="infobox-data">
                                                                                ...
                                                                                <div class="infobox-content" style="width: 580px">
                                                                                    <?php echo htmlspecialchars_decode($one['direction']); ?>
                                                                                </div>
                                                                        </div>
                                                                </div>
                                                                <?php endif;?>
                                                                ...
                                                                <div class="infobox infobox-blue"  style="width: 600px">
                                                                        <div class="infobox-data">
                                                                                ...
                                                                                <div class="infobox-content"><?php echo htmlspecialchars_decode($one['paper']); ?></div>
                                                                        </div>
                                                                </div>
                                                                <?php endif; ?>
                                                                <?php if($one['project']): ?>
                                                                <div class="infobox infobox-blue"  style="width: 600px">
                                                                        <div class="infobox-data">
                                                                                ...
                                                                                <div class="infobox-content"><?php echo htmlspecialchars_decode($one['project']); ?></div>
                                                                        </div>
                                                                </div>
                                                                <?php endif; ?>
                                                            </div>
                                                ...
                                                <?php if($one['status'] == 0): ?>
                                                <td class="label-info">
                                                    <label class="text-center" style="color: #ffffff">正在审核中</label>
                                                </td>
                                                <?php elseif($one['status'] == 1): ?>
                                                <td class="label-success">
                                                    <label class="text-center" style="color: #ffffff">审核已通过</label>
                                                </td>
                                                <?php elseif($one['status'] == 2): ?>
                                                <td class="label-important">
                                                    <label class="text-center" style="color: #ffffff">审核不通过</label>
                                                </td>
                                                <?php elseif($one['status'] == 3): ?>
                                                <td class="label-info">
                                                    <label class="text-center" style="color: #ffffff">审核已超时</label>
                                                </td>
                                                <?php endif; ?>
                                            </tr>
                                            <?php $i++;endforeach; ?>
