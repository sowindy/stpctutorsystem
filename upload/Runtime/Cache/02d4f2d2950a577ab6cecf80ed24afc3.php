			...
			<div class="main-content">
				...
				<div class="page-content">
                                    <table class="table table-bordered table-hover table-striped">
                                        ...
                                        <tbody>
                                            <?php $i = 1;foreach($allposition as $one): ?>
                                            <tr>
                                                <td><?php echo ($i); ?></td>
                                                ...
                                                <td style="width: 25%">
                                                    <?php if($one['demand']): ?>
                                                    <a href="#detail<?php echo ($one["id"]); ?>" class="btn btn-small btn-success" data-toggle="modal">实习要求</a>
                                                    ...
                                                    <?php else: ?>
                                                    <a href="#" class="btn btn-small btn-success disabled">实习要求</a>
                                                    <?php endif; ?>
                                                    <a href="<?php echo U('editposition',array('id'=>$one['id']));?>" class="btn btn-small btn-info">编辑</a>
                                                    <?php if($one['status'] == 1): ?>
                                                    <a href="<?php echo U('cancelposition',array('id'=>$one['id']));?>" class="btn btn-small btn-danger">取消发布</a>
                                                    <?php elseif($one['status'] == 0): ?>
                                                    <a href="<?php echo U('publishposition',array('id'=>$one['id']));?>" class="btn btn-small btn-warning">发布</a>
                                                    <?php endif; ?>
                                                </td>
                                            </tr>
                                            <?php $i++;endforeach; ?>
