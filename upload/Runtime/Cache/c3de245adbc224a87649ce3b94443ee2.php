			...
			<div class="main-content">
				...
				<div class="page-content">					
                                    <div class="span8 offset1">
                                        <form class="form-horizontal" id="form" method="post" action="<?php echo U('Practice/infohandler');?>" />
                                            ...
                                            <div class="control-group">
                                                    ...
                                                    <div class="controls">
                                                        <div class="span6">
                                                            <input type="text" name="corporate" class="span6" id="form-field-1" placeholder="" value="<?php echo ($userinfo["corporate"]); ?>" />
                                                        </div>
                                                    </div>
                                            </div>
                                            <div class="control-group">
                                                    <label class="control-label" for="form-field-2">公司简介：</label>
                                                    <div class="controls">
                                                                    ...
                                                                    <div class="widget-box">
                                                                            ...
                                                                            <div class="widget-body">
                                                                                    <div class="widget-main no-padding">
                                                                                            <div class="wysiwyg-editor editor_form" id="about"><?php echo htmlspecialchars_decode($userinfo['corporate_about']); ?></div>
                                                                                    </div>
                                                                            </div>
                                                                    </div>
                                                            </div>
