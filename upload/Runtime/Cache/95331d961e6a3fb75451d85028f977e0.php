			...
			<div class="main-content">
				...
				<div class="page-content">
                                    <div class="span8 offset1">
                                        <form class="form-horizontal" id="form" method="post" action="<?php echo U('editpracticehandler');?>" />
                                            <input type="hidden" name="ha" value="<?php echo ($ha); ?>" />
                                            <input type="hidden" name="id" value="<?php echo ($id); ?>" />
                                            <input type="hidden" name="pid" value="<?php echo ($pid); ?>" />
                                            
                                            <div class="control-group">
                                                    <label class="control-label" for="form-field-2">公司名称：</label>

                                                    <div class="controls">
                                                        <div class="span6">
                                                            <input type="text" name="corporate" class="span6" id="form-field-1" placeholder="如“张三”" value="<?php echo ($corporate["corporate"]); ?>" />
                                                        </div>
                                                    </div>
                                            </div>
                                            ...
                                            <div class="control-group">
                                                    ...
                                                    <div class="controls">
                                                            <input type="hidden" id="corporate_about" name="corporate_about" value="" />
                                                            <div class="span6">
                                                                    <div class="widget-box">
                                                                            ...
                                                                            <div class="widget-body">
                                                                                    <div class="widget-main no-padding">
                                                                                            <div class="wysiwyg-editor editor_form" id="about"><?php echo htmlspecialchars_decode($corporate['corporate_about']); ?></div>
                                                                                    </div>
                                                                            </div>
                                                                    </div>
                                                            </div>
                                            ...
                                            <div class="control-group">
                                                    ...
                                                    <div class="controls">
                                                        <div class="span6">
                                                            <input type="text" name="contacts" class="span6" id="form-field-1" placeholder="如“张三”" value="<?php echo ($practice["contacts"]); ?>" />
                                                        </div>
                                                    </div>
                                            </div>
                                            ...
                                            <div class="control-group">
                                                    ...
                                                    <div class="controls">
                                                        <div class="span6">
                                                            <input type="text" name="phone" class="span6" id="form-field-1" placeholder="如“13721093421”" value="<?php echo ($practice["phone"]); ?>" />
                                                        </div>
                                                    </div>
                                            </div>
                                            <div class="control-group">
                                                    ...
                                                    <div class="controls">
                                                        <div class="span6">
                                                            <input type="text" name="tel" class="span6" id="form-field-1" placeholder="如“0551-63600110”" value="<?php echo ($practice["tel"]); ?>" />
                                                        </div>
                                                    </div>
                                            </div>
                                            ...
                                            <div class="control-group">
                                                    ...
                                                    <div class="controls">
                                                        <div class="span6">
                                                            <input type="text" name="email" id="form-field-1" class="span6" placeholder="如“youname@domain”" value="<?php echo ($practice["email"]); ?>" />
                                                        </div>
                                                    </div>
                                            </div>
                                            ...
                                            <div class="control-group">
                                                    ...
                                                    <div class="controls">
                                                        <div class="span6">
                                                            <input type="text" name="station" class="span6" id="form-field-1" placeholder="" value="<?php echo ($practice["station"]); ?>" />
                                                        </div>
                                                    </div>
                                            </div>
                                            ...
                                            <div class="control-group">
                                                    ...
                                                    <div class="controls">
                                                        <div class="span6">
                                                            <input type="number" name="num" class="span6" id="form-field-1" placeholder="" value="<?php echo ($practice["num"]); ?>" />
                                                        </div>
                                                    </div>
                                            </div>
                                                    ...
                                                    <div class="controls">
                                                            ...
                                                            <div class="span6">
                                                                    <div class="widget-box">
                                                                            ...
                                                                            <div class="widget-body">
                                                                                    <div class="widget-main no-padding">
                                                                                            <div class="wysiwyg-editor editor_form" id="demand"><?php echo htmlspecialchars_decode($practice['demand']); ?></div>
                                                                                    </div>
                                                                            </div>
                                                                    </div>
                                                            </div>
