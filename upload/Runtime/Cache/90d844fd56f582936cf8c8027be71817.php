		...
		<div class="main-container container-fluid">
			...
			<div class="main-content">
				<div class="breadcrumbs" id="breadcrumbs">
					...
					<form id="submit_grade" method="get" action="<?php echo U('allocatetutor');?>">
						请选择年级：
				...
				<div class="page-content">
                                    <form action="<?php echo U('allocatetutorhandler');?>" method="post">
                                        <hr>
                                        ...
                                        <div class="span5">
                                            ...
                                            <table class="table table-bordered table-condensed table-striped datatable">
                                                ...
                                                <tbody>
                                                    <?php foreach($tutor as $one): ?>
                                                        <?php if($one['stunumber'] >= 6) continue; ?>
                                                        <tr>
                                                            <th><?php echo ($one["name"]); ?><span class="badge badge-important"><?php echo ($one["stunumber"]); ?></span></th>
                                                            <th>
                                                            ...
                                                            <th><?php echo ($one["phone"]); ?></th>
                                                            <th style="text-align: center"><input type="radio" name="tutor" value="<?php echo ($one["id"]); ?>" style="position: inherit;opacity: 1" /></th>
                                                        </tr>
                                                    <?php endforeach; ?>
